...
<script runat="server">
    ...
    private void GetUsers()
    {
        ...
        string cmdstr = "SELECT username FROM mytable";
        ...
        {
            string curr = row["username"].ToString();
            if (curr != "Admin")
            {
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.Form["submit"] != null)
        {
            ...
            try
            {
                ...
                sqlFormattedDate = c.Date.ToString("yyyy-MM-dd");
                ...
                {
                    cmd.Connection = conn;
                    string comstr = "UPDATE mytable set password=@password, email=@email,sex=@sex,starter=@starter,dob=@dob WHERE username=@userid";
...
<asp:content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form  name="myform" id="myform" method="post" onsubmit="return masterCheck()" action="admin-update.aspx">
    <table>
        <tr><td>UserId: </td><td><%=print  %></td></tr>
